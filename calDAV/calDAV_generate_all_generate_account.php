...
if (isActionAccessible($guid, $connection2, '/modules/calDAV/calDAV_generate_all.php') == false) {
        ...
        //Proceed!
        $form = Form::create('calDAVPreferences', $session->get('absoluteURL').'/modules/'.$session->get('module').'/calDAV_generate_all_generate_account_process.php');
        ...
        $row = $form->addRow();
            ...
            $row->addTextField('email')->required()->readOnly()->setValue($_GET['email']);
